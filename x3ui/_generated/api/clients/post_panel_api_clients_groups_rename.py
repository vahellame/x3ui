...
from ...models.clients_groups_rename_request import ClientsGroupsRenameRequest
from ...models.post_panel_api_clients_groups_rename_response_200 import (
...
def _get_kwargs(
    *,
    body: ClientsGroupsRenameRequest,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PostPanelApiClientsGroupsRenameResponse200.from_dict(
            response.json()
        )
