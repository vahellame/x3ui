...
T = TypeVar("T", bound="ServerGetWebCertFiles")


@_attrs_define
class ServerGetWebCertFiles:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        server_get_web_cert_files = cls(
            web_cert_file=web_cert_file,
            web_key_file=web_key_file,
        )

        server_get_web_cert_files.additional_properties = d
        return server_get_web_cert_files
