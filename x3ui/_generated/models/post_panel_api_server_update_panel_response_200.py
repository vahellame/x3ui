...
if TYPE_CHECKING:
    from ..models.server_update_panel import ServerUpdatePanel
...
class PostPanelApiServerUpdatePanelResponse200:
    ...
    Attributes:
        success (bool | Unset):
        msg (str | Unset):
        obj (ServerUpdatePanel | Unset):
    """

    success: bool | Unset = UNSET
    msg: str | Unset = UNSET
    obj: ServerUpdatePanel | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_obj, Unset):
            ...
            obj = ServerUpdatePanel.from_dict(_obj)
