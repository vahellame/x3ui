...
T = TypeVar("T", bound="NodesInboundsRequest")


@_attrs_define
class NodesInboundsRequest:
    """
    Attributes:
        name (str | Unset):
        scheme (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        nodes_inbounds_request.additional_properties = d
        return nodes_inbounds_request
