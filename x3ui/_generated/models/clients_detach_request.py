...
T = TypeVar("T", bound="ClientsDetachRequest")


@_attrs_define
class ClientsDetachRequest:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        clients_detach_request = cls(
            inbound_ids=inbound_ids,
        )

        clients_detach_request.additional_properties = d
        return clients_detach_request
