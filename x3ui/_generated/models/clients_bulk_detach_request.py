...
T = TypeVar("T", bound="ClientsBulkDetachRequest")


@_attrs_define
class ClientsBulkDetachRequest:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        clients_bulk_detach_request = cls(
            emails=emails,
            inbound_ids=inbound_ids,
        )

        clients_bulk_detach_request.additional_properties = d
        return clients_bulk_detach_request
