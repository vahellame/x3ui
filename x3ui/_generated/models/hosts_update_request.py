...
T = TypeVar("T", bound="HostsUpdateRequest")


@_attrs_define
class HostsUpdateRequest:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        hosts_update_request.additional_properties = d
        return hosts_update_request
