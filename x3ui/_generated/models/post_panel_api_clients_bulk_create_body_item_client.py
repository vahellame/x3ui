...
T = TypeVar("T", bound="PostPanelApiClientsBulkCreateBodyItemClient")


@_attrs_define
class PostPanelApiClientsBulkCreateBodyItemClient:
    """
    Attributes:
        email (str | Unset):
        total_gb (int | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        post_panel_api_clients_bulk_create_body_item_client = cls(
            email=email,
            total_gb=total_gb,
        ...
        post_panel_api_clients_bulk_create_body_item_client.additional_properties = d
        return post_panel_api_clients_bulk_create_body_item_client
