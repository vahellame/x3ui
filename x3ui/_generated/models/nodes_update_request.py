...
T = TypeVar("T", bound="NodesUpdateRequest")


@_attrs_define
class NodesUpdateRequest:
    """
    Attributes:
        name (str | Unset):
        remark (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        nodes_update_request.additional_properties = d
        return nodes_update_request
