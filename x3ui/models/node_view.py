...
class NodeView:
    ...
    write-only: responses expose only whether a node has a token configured.
        ...
        Attributes:
            active_count (int):  Example: 20.
            address (str):  Example: node.example.com.
            allow_private_address (bool):
            base_path (str):  Example: /.
            client_count (int):  Example: 25.
            config_dirty (bool):
            config_dirty_at (int):
            cpu_pct (float):  Example: 12.5.
            created_at (int):  Example: 1700000000.
            depleted_count (int):  Example: 1.
            disabled_count (int):  Example: 2.
            enable (bool):  Example: True.
            guid (str):  Example: node-guid.
            has_api_token (bool):  Example: True.
            id (int):  Example: 1.
            inbound_count (int):  Example: 3.
            inbound_sync_mode (str):  Example: all.
            inbound_tags (list[str]):  Example: ['in-443-tcp'].
            last_error (str):
            last_heartbeat (int):  Example: 1700000000.
            latency_ms (int):  Example: 42.
            mem_pct (float):  Example: 45.2.
            name (str):  Example: edge-1.
            net_down (int):  Example: 1048576.
            net_up (int):  Example: 2097152.
            online_count (int):  Example: 5.
            outbound_tag (str):  Example: direct.
            panel_version (str):  Example: v3.x.x.
            pinned_cert_sha_256 (str):
            port (int):  Example: 2053.
            remark (str):  Example: Primary edge.
            scheme (str):  Example: https.
            status (str):  Example: online.
            tls_verify_mode (str):  Example: verify.
            updated_at (int):  Example: 1700003600.
            uptime_secs (int):  Example: 86400.
            xray_error (str):
            xray_state (str):  Example: running.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        inbound_sync_mode = self.inbound_sync_mode
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        inbound_sync_mode = d.pop("inboundSyncMode")
        ...
        tls_verify_mode = d.pop("tlsVerifyMode")
        ...
        node_view.additional_properties = d
        return node_view
