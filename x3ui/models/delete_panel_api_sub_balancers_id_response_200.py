...
T = TypeVar("T", bound="DeletePanelApiSubBalancersIdResponse200")


@_attrs_define
class DeletePanelApiSubBalancersIdResponse200:
    """
    Attributes:
        success (bool | Unset):
        msg (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        delete_panel_api_sub_balancers_id_response_200 = cls(
            success=success,
            msg=msg,
            obj=obj,
        )

        delete_panel_api_sub_balancers_id_response_200.additional_properties = d
        return delete_panel_api_sub_balancers_id_response_200
