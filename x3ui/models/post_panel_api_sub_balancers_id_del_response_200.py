...
T = TypeVar("T", bound="PostPanelApiSubBalancersIdDelResponse200")


@_attrs_define
class PostPanelApiSubBalancersIdDelResponse200:
    """
    Attributes:
        success (bool | Unset):
        msg (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        post_panel_api_sub_balancers_id_del_response_200 = cls(
            success=success,
            msg=msg,
            obj=obj,
        )

        post_panel_api_sub_balancers_id_del_response_200.additional_properties = d
        return post_panel_api_sub_balancers_id_del_response_200
